          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                I am <span className="text-white font-bold drop-shadow">Shashank Singh</span>, a creative developer who enjoys building games, interactive websites, AI-powered tools, and polished digital experiences.
              </p>
            ...
            <div className="space-y-5 relative z-10">
              ...
              <ul className="space-y-3.5 text-sm text-white/80 font-light">
                <li className="flex items-start gap-2.5">
                  ...
                  <span>Built <strong className="text-white">3 games</strong> across cricket, coding, and cybersecurity.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Created <strong className="text-white">5 web projects</strong> spanning productivity, AI, cybersecurity, calculators, and games.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
